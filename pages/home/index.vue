...
// import isSeller from '/components/isSellerVue.vue';
...
// // Get first user if response is array
// const currentUserData = computed(() =>
//   Array.isArray(currentUserNow.value) ? currentUserNow.value[0] : currentUserNow.value
// )
...
<template>
  ...
  <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
    <div v-if="!pendingUserNow">
      <h1 v-if="!isSeller" class="text-3xl font-bold text-gray-900">
        Admin Dashboard 
      </h1>
      ...
      <div class="flex flex-col sm:flex-row gap-3">
        <div class="relative">
          ...
          <svg class="absolute right-2 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400 pointer-events-none"
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-lg font-semibold text-green-600 mt-1">{{ formatCurrency(dashboardData.transactions.amount) }}
          </p>
          <div class="flex items-center mt-2">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
      <div class="flex items-center justify-between">
        <div>
          ...
          <div class="mt-2">
            <NuxtLink to="/home/sellers?status=pending"
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
      <div class="flex items-center justify-between">
        <div>
          ...
          <div class="mt-2">
            <NuxtLink to="/home/sellers?status=approved"
  ...
  <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center space-x-3">
        <button @click="refreshActivity" :disabled="activityLoading"
          class="text-sm text-green-600 hover:text-green-700 font-medium inline-flex items-center disabled:opacity-50">
          <svg class="w-4 h-4 mr-1" :class="{ 'animate-spin': activityLoading }" fill="none" stroke="currentColor"
            viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
